...
static const char *colors[][3]      = {
	...
	[SchemeHid]  = { col_nord1, col_nord2, col_nord2 },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_nord2, "-nf", col_nord1, "-sb", col_nord3, "-sf", col_nord2, NULL };
